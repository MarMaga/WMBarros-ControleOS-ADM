...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="novo_usuario.php" id="formCad">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="telefone" id="telefone"
                                            class="form-control num cel obg" value=<?= $dados['tel_usuario'] ?>
                            ...
                            <?php } else if ($dados['tipo_usuario'] == 3) { ?>
                                    <div id="divUsuarioTecnico">
                                        <div class="form-group">
        ...
        <?php if ($dados['tipo_usuario'] == 2) { ?>
        <script>
            ConsultarSetorAlterarUsuario(<?= $dados['id_setor'] ?>);
        </script>
        <?php } ?>
