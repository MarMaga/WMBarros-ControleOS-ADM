                    ...
                    <div class="card-body">
                        <form id="formNovoEq" method="post" action="equipamento.php">
                            <input type="hidden" id="idTipo"
                                value="<?= isset($equipamento) ? $equipamento['tipoequipamento_id'] : '' ?>">
                            <input type="hidden" id="idModelo"
                                value="<?= isset($equipamento) ? $equipamento['modelo_id'] : '' ?>">
                            <input type="hidden" id="idEquipamento"
                                value="<?= isset($equipamento) ? $_GET['id'] : '' ?>">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Modelo</label>
                                    <select class="form-control select2 obg" name="modelo" id="modelo"
                                        style="width: 100%;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="identificacao" id="identificacao" class="form-control obg"
                                    ...
                                    value="<?= $titulo == ESTADO_TELA_ALTERAR ? $equipamento['ident_equipamento'] : '' ?>">
                            </div>
                            <div class="form-group">
                                <label>Descrição</label>
                                <textarea class="form-control obg" rows="3" name="descricao" id="descricao"
                                    style="text-transform: uppercase"><?= (isset($equipamento)) ? $equipamento['desc_equipamento'] : '' ?></textarea>
                            </div>
