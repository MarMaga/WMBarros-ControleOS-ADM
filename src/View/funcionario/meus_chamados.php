        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formMeusChamados" method="post" action="meus_chamados.php">
                            ...
                            <button onclick="return NotificarCampos('formMeusChamados')" class="btn btn-success" name="btn_pesquisar">Pesquisar</button>
                        </form>
                    </div>
                </div>
                <div class="card">
